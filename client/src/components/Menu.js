...
export default class Menu extends Component {
    ...
    <section className="sidebar">
      ...
      <ul className="sidebar-menu" data-widget="tree">
        ...
        <li className="treeview">
          <a href="#">
            <i className="fa fa-edit" /> <span>Applications</span>
            <span className="pull-right-container">
              <i className="fa fa-angle-left pull-right" />
            </span>
          </a>
        ...
        <li className="treeview">
          <a href="#">
            <i className="fa fa-folder" /> <span>Leave Centre</span>
            <span className="pull-right-container">
              <i className="fa fa-angle-left pull-right" />
            </span>
          </a>
          <ul className="treeview-menu">
            <li><a href="pages/examples/invoice.html"><i className="fa fa-circle-o" /> Staff on Leave</a></li>
            <li><a href="/add-leave"><i className="fa fa-circle-o" /> Leave Applications</a></li>
